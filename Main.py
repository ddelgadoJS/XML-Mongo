...
xmlPath = Entry(xmlFrame, font = "Helvetica 12")
...
Button(bottomFrame, text = "Cargar", font = "Helvetica 12", command = lambda: Funs.xmlParserJSON(xmlPath.get())).pack(side = "bottom", padx = 10, pady = 10)
